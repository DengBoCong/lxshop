 ...
 **/
@Entity
@Table(name = "l_factory_user", schema = "lxshop", catalog = "")
public class LFactoryUserEntity {
    private int id;
    ...
    @Basic
    @Column(name = "capacity", nullable = false, length = 1000)
    ...
    @Basic
    @Column(name = "quality", nullable = false, length = 1000)
    ...
    @Basic
    @Column(name = "stability", nullable = false, length = 1000)
    ...
    @Basic
    @Column(name = "circumstance", nullable = false, length = 1000)
    ...
    public boolean equals(Object o) {
        ...
        LFactoryUserEntity that = (LFactoryUserEntity) o;
