 ...
 * @description:
 * @author: DBC
 * @create: 2019-08-26 20:10
 **/
@Entity
@Table(name = "l_factory_licence", schema = "lxshop", catalog = "")
public class LFactoryLicenceEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        LFactoryLicenceEntity that = (LFactoryLicenceEntity) o;
